"""Client-side input validation for the WRC spider.
...
def parse_iso_date(raw: str) -> date:
    ...
    than letting date.fromisoformat's own message stand alone.
    """
    try:
...
def validate_date_range(start_date: date, end_date: date) -> None:
    ...
    verified live that the site returns an empty result set gracefully (HTTP
